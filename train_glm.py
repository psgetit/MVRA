...
def main(optimize_strategy, descent_strategy):
    ...
    candidate_configs = {
        ...
        "sgd": {
            ...
            "per_gpu_batch_size": {                 # SGD takes less memory, so we use large batch.
                512+10: 2, #10,
                256+10: 4, #20,                         # For those dataset max_window_length=256 & max_generated_token=10 & 3090GPU
                128+10: 8, #40,                         # For those dataset max_window_length=128 & max_generated_token=10 & 3090GPU
                64+10:  16,#80,                          # For those dataset max_window_length=64 & max_generated_token=10 & 3090GPU
        ...
        "adamw": {
            ...
            "per_gpu_batch_size": {                 # AdamW takes more memory, so we use small batch.
                512+10: 2, #5,
                256+10: 4, #10,                          # For those dataset max_window_length=256 & max_generated_token=10 & 3090GPU
                128+10: 8, #20,                         # For those dataset max_window_length=128 & max_generated_token=10 & 3090GPU
                64+10:  16,#40,                          # For those dataset max_window_length=64 & max_generated_token=10 & 3090GPU
    ...
    tokenizer, model = load_model(
        pretrained_model_path = './GLM4-9B/glm-4-9b',
        lora_r = candidate_configs[optimize_strategy]["expert_rank"],
        lora_alpha = 16,
        lora_dropout = 0.05,
        lora_modules = ["query_key_value"], #['q_proj', 'k_proj', 'v_proj', 'o_proj'],
